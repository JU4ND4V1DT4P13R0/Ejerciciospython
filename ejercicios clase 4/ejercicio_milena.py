...
balota  =  entrada ( "escoja el color de la balota: roja, verde, blanca, amarilla y negra" )
...
si  compra  >=  50000 :
    si  balota == ( "roja" ):
        ...
        print ( valor del descuento: { des_blanca } ,valor a pagar con descuento aplicado { balotablanca_des1 } ' )
    elif  balota  == ( "amarilla" ):
        print ( valor del descuento: { des_amarilla } ,valor a pagar con descuento aplicado { balotaamarilla_des1 } ' )
    elif  balota  == ( "negra" ):
        print ( valor del descuento: { des_negra } ,valor a pagar con descuento aplicado { balotanegra_des1 } ' )
más :
